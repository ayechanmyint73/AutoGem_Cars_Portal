...
<head>
<meta charset="UTF-8">
<title>AutoGem | Search Car Results Page</title>
...
<body>
	...
	<div class="container-fluid">
		...
		<h3 class="car-title">Search Car Results</h3>
		<div class="row">
			<div class="col-sm-4">
			
				<c:url var="get_search_url" value="search"/>
				
				<form action="${get_search_url}" id="myform" method="get" class="form-inline text-right" style="margin-left: 100px;">
				...
				<sec:authorize access="hasRole('Users')">
					...
					<c:if test="${empty search_cars}">
						<div>
							<div class="alert alert-danger"> No Matching Item Found. </div>	
							<div class="alert alert-danger"> Please try with another keyword.</div>	
						</div>	
					</c:if> 
